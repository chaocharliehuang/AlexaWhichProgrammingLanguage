...
// Questions
var nodes = [{ "node": 1, "message": "Do you already have some programming knowledge", "yes": 2, "no": 8 },
             { "node": 2, "message": "Do you want to develop mobile applications", "yes": 3, "no": 4 },
             { "node": 3, "message": "Do you want to develop IOS applications", "yes": 5, "no": 10 },
             { "node": 4, "message": "Do you only want to develop web applications", "yes": 10, "no": 6 },
             { "node": 5, "message": "Do you want to learn a newer, still under-development language", "yes": 11, "no": 12 },
             { "node": 6, "message": "Do you want to learn a language with simple syntax and dynamic typing", "yes": 7, "no": 9 },
             { "node": 7, "message": "Do you want to learn a language that is emphasizes explicitness and structure", "yes": 13, "no": 14 },

// Answers & descriptions
             { "node": 8, "message": "HTML, CSS, and Java script", "yes": 0, "no": 0, "description": "If you do not know any programming languages, HTML, CSS and Java script are the three fundamental languages of the web and are a good starting point." },
             { "node": 9, "message": "Java", "yes": 0, "no": 0, "description": "Java is a statically typed language popular for enterprise applications, and also powers Android applications." },
             { "node": 10, "message": "PHP", "yes": 0, "no": 0, "description": "PHP is a widely used server scripting language used for making dynamic and interactive web pages." },
             { "node": 11, "message": "Swift", "yes": 0, "no": 0, "description": "Swift is a modern language for developing applications for the Apple ecosystem, and the language with which Apple intends to move forward." },
             { "node": 12, "message": "Objective C", "yes": 0, "no": 0, "description": "Objective C is used to write desktop software and mobile applications, and has been the de facto language for IOS development for the past decade." },
             { "node": 13, "message": "Python", "yes": 0, "no": 0, "description": "Python is a general purpose language used for web development as well as data science and mathematics, and emphasizes explicitness and structure." },
             { "node": 14, "message": "Ruby", "yes": 0, "no": 0, "description": "Ruby is a language often associated with the Rails framework for fast web development, and emphasizes expressiveness and flexibility." }
];
...
var welcomeMessage = "Welcome to the decision tree for choosing which programming language you should learn. Are you ready to start?";

// This is the message that is repeated if the response to the initial welcome message is not heard
var repeatWelcomeMessage = "Say yes to start again or no to quit.";

// this is the message that is repeated if Alexa does not hear/understand the reponse to the welcome message
var promptToStartMessage = "Say yes to continue, or no to end the decision tree.";

// This is the prompt during the game when Alexa doesnt hear or understand a yes / no reply
var promptToSayYesNo = "Say yes or no to answer the question.";

// This is the response to the user after the final question when Alex decides on what group choice the user should be given
var decisionMessage = "I think you should learn";

// This is the prompt to ask the user if they would like to hear a short description of thier chosen profession or to play again
var playAgainMessage = "Say 'tell me more' to hear a short description for this language, or do you want to play again?";

// this is the help message during the setup at the beginning of the game
var helpMessage = "I will ask you some questions that will identify which programming language you should learn. Want to start now?";
